...
REGISTER_TYPE(battery_power_supply_status, std::uint8_t, false)
REGISTER_TYPE(battery_power_supply_health, std::uint8_t, false)
REGISTER_TYPE(battery_power_supply_technology, std::uint8_t, false)
